...
const GasInput: React.FC<GasInputProps> = ({ 
  ...
  const geminiPresets = {
    "Ex 1 (DT)": { H2: 30.1, CH4: 43.3, C2H6: 45.1, C2H4: 122.5, C2H2: 42.2 },
    "Ex 2 (D2)": { H2: 79.5, CH4: 5.8, C2H6: 3.3, C2H4: 25.0, C2H2: 18.5 },
    "Ex 3 (D1)": { H2: 78.0, CH4: 20.0, C2H6: 11.0, C2H4: 13.0, C2H2: 28.0 },
    "Ex 4 (T3)": { H2: 85.2, CH4: 104.5, C2H6: 38.9, C2H4: 300.4, C2H2: 2.2 },
    "Ex 5 (T2)": { H2: 110.6, CH4: 458.8, C2H6: 242.6, C2H4: 406.4, C2H2: 0.0 },
    "Ex 6 (T1)": { H2: 15.0, CH4: 83.48, C2H6: 268.1, C2H4: 8.5, C2H2: 0.0 },
    "Ex 7 (PD)": { H2: 7907.0, CH4: 467.0, C2H6: 249.0, C2H4: 2.0, C2H2: 0.0 },
    "Ex 8 (N)": { H2: 0.0, CH4: 0.0, C2H6: 0.0, C2H4: 2.0, C2H2: 0.0 },
  };
